...
class ChefController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('chef.index')->with('message', 'Nouveau chef ajouté avec succès');
    }
    ...
    public function update(Request $request, Chef $chef)
    {
        ...
        return redirect()->route('chef.index')->with('message', 'Modifié avec succès');
    }
    ...
    public function destroy(Chef $chef)
    {
        ...
        $chef->delete();
        return redirect()->route('chef.index')->with('message', 'Chef supprimé avec succès');
    }
}
